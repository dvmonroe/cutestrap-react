...
function Input(_ref) {
  ...
  return React.createElement("input", _extends({}, pick(props, inputValues), {
...
function TextField(_ref) {
  ...
  return React.createElement(Label, _extends({}, pick(props, labelOptions), {
    value: label
  }), React.createElement(Input, _extends({}, pick(props, inputOptions), {
    inputValue: value
  })));
}
...
export { Button, Checkbox, Column, Grid, Input, Label, RadioButton, Select, Textarea, TextField, Wrapper };
